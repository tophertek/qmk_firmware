...
#define FN1_SPC     LT(_FN1, KC_SPC)
#define CTL_TAB     CTL_T(KC_TAB)
#define SFT_UP     SFT_T(KC_UP)
#define ALT_LEFT     ALT_T(KC_LEFT)
#define CTL_RIGHT     CTL_T(KC_RIGHT)
...
[_MA] = LAYOUT(
  ...
  KC_LSFT,          KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,  KC_DOT,   SFT_UP,  MO(_FN1), \
  KC_LCTL,    KC_LGUI,  KC_LALT,  MO(_PN),        KC_SPC,         FN1_SPC,         MO(_FN),  ALT_LEFT,  KC_DOWN,   CTL_RIGHT),  \
...
[_FN] = LAYOUT(
  ...
  _______,          _______,  _______,  _______,  _______,  _______,  KC_END,  BL_TOGG,  BL_DEC,   BL_INC,   _______,  _______,  \
...
[_PN] = LAYOUT(
  ...
  RGB_TOG,    RGB_HUI,  RGB_SAI,  RGB_VAI,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,  KC_RIGHT,  _______,  _______,  \
