...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  CTL_ESC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_ASTR, KC_HOME,  KC_END, KC_COLN, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  CTL_ESC,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_HOME, KC_END,  KC_MINS, KC_EQL,  KC_LPRN, KC_RPRN, KC_PIPE, \
